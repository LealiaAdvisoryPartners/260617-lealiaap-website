        ...
        {services.map((service, index) => {
          ...
          return (
            ...
            >
              <Link
                to={service.link}
                className="group relative block h-full p-8 lg:p-10 rounded-[var(--radius)] bg-card border border-border/60 hover:border-accent/40 transition-all duration-500 overflow-hidden"
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(400px circle at 50% 0%, hsl(var(--accent) / 0.08), transparent 70%)",
                  }}
                />

                <div className="relative">
                  <div className="flex items-start justify-between mb-10">
                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-secondary group-hover:bg-accent/10 transition-colors duration-500">
